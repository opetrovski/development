...
public class EC2Processor {
    ...
    public InstanceStatus process() throws APPlatformException {
        ...
        try {
            ...
            case EC2_IMPORT:
                newState = manageImportProcess(flowState, result);
                break;
            case EC2_CREATION:
     ...
     * @throws APPlatformException
     */
    FlowState manageImportProcess(FlowState flowState, InstanceStatus result)
            throws APPlatformException {
    ...
    FlowState manageProvisioningProcess(FlowState flowState,
        ...
        case CREATION_REQUESTED:
            String imageId = ec2comm.resolveAMI(ph.getImageName());
